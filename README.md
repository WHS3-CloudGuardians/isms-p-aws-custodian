...
### Prowler & CloudCustodian 기반 ISMS-P 기준 준수 및 대응 자동화 툴
...
### 기능
1. 보안 점검 및 대응 자동화: Prowler로 취약점 점검 -> 점검 결과의 CHECKID와 동일한 이름의 Cloud Custodian 정책으로 취약점 조치
2. 이벤트 기반 탐지/주기적 탐지로 AWS 환경에서의 ISMS-P 기준 준수
